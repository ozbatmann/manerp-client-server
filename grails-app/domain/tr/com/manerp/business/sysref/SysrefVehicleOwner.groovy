...
class SysrefVehicleOwner implements BaseDomain {
    ...
    static mapping = {
//        table name: "sysref_vehicle_owner", schema: "business"
//        id generator: 'sequence', params: [sequence: 'business.SEQ_SYSREF_VEHICLE_OWNER']
    }
